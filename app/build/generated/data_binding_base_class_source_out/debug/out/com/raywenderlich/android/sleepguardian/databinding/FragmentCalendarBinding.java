...
public final class FragmentCalendarBinding implements ViewBinding {
  ...
  private FragmentCalendarBinding(@NonNull FrameLayout rootView, @NonNull TextView textView) {
  ...
  public static FragmentCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCalendarBinding((FrameLayout) rootView, textView);
    }
